program Qa
    ...
    open(3,file="saida3-a1-11371311.dat",status="replace")
    write(*,*)"digite o valor angulo em graus"
    read(*,*)conv
    write(*,*)"digite o valor de variação do tempo"
    ...
    do while(1<8)
        ...
        teta=teta+w*det
        i=i+1
        e=(9.8**2)*(w**2)*0.5+(9.8**2)*teta**2/2!para teta pequeno
        if(t>=20)then
            exit
        endif
        w=wi
